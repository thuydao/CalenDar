...
function td_todayInfo(mm,yy)
{
    ...
    var lunarDate = currentMonth[0];
    var solarDate = today.getDate();
    var solarMonth = today.getMonth()+1;
    var solarYear = today.getFullYear();

    return td_infoDay(lunarDate.day, lunarDate.month, lunarDate.year, lunarDate.leap, lunarDate.jd, solarDate, solarMonth, solarYear);
}

////////// end Thuy Đào funtion /////////
